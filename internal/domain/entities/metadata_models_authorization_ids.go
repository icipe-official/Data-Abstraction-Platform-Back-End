...
type MetadataModelsAuthorizationIDs struct {
...
type metadataModelsAuthorizationIDsRepository struct {
...
func MetadataModelsAuthorizationIDsRepository() metadataModelsAuthorizationIDsRepository {
	return metadataModelsAuthorizationIDsRepository{
		RepositoryName: "metadata_models_authorization_ids",
